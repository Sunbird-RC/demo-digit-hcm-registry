...
const {CERTIFICATE_CONTROLLER_ID, DOCUMENT_LOADER_URL} = require("../config/config");
const {Ed25519Signature2018, RsaSignature2018} = jsigs.suites;
const request = require('request');
const vc = require('vc-js');
const credentialsv1 = require('./credentialsv1.json');
const DigitCredential = require('./DIGITContext.json');
...
let documentLoaderMapping = {"https://w3id.org/security/v1": contexts.get("https://w3id.org/security/v1"), "https://w3id.org/security/v2": contexts.get("https://w3id.org/security/v2")};
...
// documentLoaderMapping[DOCUMENT_LOADER_URL] = DigitCredential;
